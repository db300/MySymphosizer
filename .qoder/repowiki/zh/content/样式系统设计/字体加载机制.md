...
## 更新摘要
**变更内容**
- 更新@font-face声明中的字体文件路径，从ABCSymphonyDisplayVariable.ttf更改为HanYiaranyatheaterfestivalTiVF-260413VF-02.ttf
- 更新字体文件路径配置和字体加载机制说明
- 更新字体替换指南中的具体文件名示例
...
## 核心组件
- @font-face声明与字体文件路径：在样式表中通过@font-face声明三款字体（Display、Headline、Text），并指定字体文件路径。**已更新**：Display字体现使用HanYiaranyatheaterfestivalTiVF-260413VF-02.ttf文件。
...
CSS->>Font : 请求字体文件HanYiaranyatheaterfestivalTiVF-260413VF-02.ttf
HTML->>JS : 初始化脚本
JS->>FFT : 启动音频输入与分析
JS->>JS : 计算可变轴参数
...
### 组件A：可变字体的CSS声明与使用
- @font-face声明：在样式表中为每种用途声明独立的字体族，并指向对应字体文件路径。**已更新**：Display字体现在指向HanYiaranyatheaterfestivalTiVF-260413VF-02.ttf文件。
...
```mermaid
flowchart TD
Start(["开始"]) --> LoadFace["@font-face声明使用HanYiaranyatheaterfestivalTiVF-260413VF-02.ttf"]
...
- 字体文件路径：@font-face中的src指向fonts目录下的字体文件，确保相对路径正确。**已更新**：Display字体现在使用HanYiaranyatheaterfestivalTiVF-260413VF-02.ttf文件。
...
### 组件E：字体定制与主题切换
- 自定义字体集成：通过修改@font-face声明与相关选择器，替换为新的字体文件与字体族名称。**已更新**：Display字体文件已更新为HanYiaranyatheaterfestivalTiVF-260413VF-02.ttf。
...
participant Font as "可变字体HanYiaranyatheaterfestivalTiVF-260413VF-02.ttf"
Mic->>FFT : 提供音频样本
FFT->>Mapper : 输出频谱与能量
...
- 字体依赖：style.css中的@font-face声明依赖fonts目录下的字体文件。**已更新**：Display字体现在使用HanYiaranyatheaterfestivalTiVF-260413VF-02.ttf文件。
...
Style --> Fonts["fonts/HanYiaranyatheaterfestivalTiVF-260413VF-02.ttf更新"]
...
## 故障排除指南
- 字体不显示或显示为方块：检查@font-face中的src路径是否正确，确认字体文件存在且格式受支持。**已更新**：确保HanYiaranyatheaterfestivalTiVF-260413VF-02.ttf文件位于fonts目录中。
...
## 结论
本项目通过@font-face声明与font-variation-settings实现了可变字体的动态排版效果，结合音频分析与逐字符控制，创造出独特的"声音驱动"字体体验。**已更新**：Display字体现已更新为HanYiaranyatheaterfestivalTiVF-260413VF-02.ttf，提供了新的字体外观和可变轴特性。通过合理的回退策略、性能优化与主题定制，既保证了可用性与兼容性，又提升了视觉表现力。建议在后续维护中持续关注字体格式与加载策略的演进，以进一步优化用户体验。

## 附录
- 字体更换步骤与注意事项详见字体更换指南文档，涵盖Display、Headline与Text三类字体的替换流程与参数映射调整。**已更新**：指南中提到的字体文件名已更新为HanYiaranyatheaterfestivalTiVF-260413VF-02.ttf。
